...
hold on
scatter(s,Reu,'filled')
scatter(s,Rsq,'filled')
scatter(s,Rma,'filled')
scatter(s,Rco,'filled')
scatter(s,Rcr,'filled')
scatter(s,Rsp,'filled')
scatter(s,Rcma,'filled')
legend('Euclidean','Standardized Euclidean','Mahalanobis','Cosine','Correlation','Spearman','Cross-Validated Mahalanobis')
hold off
